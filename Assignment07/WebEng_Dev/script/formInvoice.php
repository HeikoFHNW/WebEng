...
<div class="control-group <?php echo !empty($tenantValidator->getInvoice_dateError()) ? 'error' : ''; ?>">
    <label class="control-label">Rechnungsdatum</label>
    <div class="controls">
        <input name="invoice_date" type="text" id="datepicker" placeholder="DD/MM/YYYY" 
               value="<?php echo !empty($tenant->getInvoice_date()) ? $tenant->getInvoice_date() : ''; ?>">
               <?php if (!empty($tenantValidator->getInvoice_dateError())): ?>
               <span class="help-inline"><?php echo $tenantValidator->getInvoice_dateError(); ?></span>
               <?php endif;?>
...
<div class="control-group <?php echo !empty($invoiceValidator->getInvoice_typeError()) ? 'error' : ''; ?>">
    ...
    <div class="controls">
        <input name="invoice_type" type="text" id="fI_invoice_type" placeholder="Miete/Reparatur/Nebenkosten"
...
<div class="control-group">
    ...
    <div class="controls">
        <textarea rows = "5" name="comment" type="text" placeholder="Fliesstext" 
                  value="<?php echo !empty($tenancy_agreement->getComment()) ? $tenancy_agreement->getComment() : ''; ?>"></textarea>
    </div>
</div>
