...
<div class="container">
    ...
    <div class="span10 offset1">
        ...
        <form class="form-horizontal" action="?controller=Tenant&action=update&id_tenant=<?php echo $tenant->getId_tenant() ?>" onkeyup="return validateMieterForm()" method="post">
